...
cdb.geo.Map = Backbone.Model.extend({
    ...
    addLayerCartoDB: function(layer) {
        this.layers.addCartoDB(layer);
    }
...
cdb.geo.LeafletMapView = cdb.geo.MapView.extend({
    ...
    _addCartoDBLayer: function() {
      ...
      this.map_leaflet.addLayer(cartodb_leaflet);
